...
<div class="container">	
	<form id="12thAcademicRegistration" modelAttribute="student12thDetails" action="Register12th.do" method="post">
		...
		<table align="center">
			...
			<tr><th>12th Roll no:</th><td><input type="text" name="student_12_roll_number" id="student_12_roll_number" /></td></tr>
			...
			<tr><th>Passing Year:</th><td><input type="text" name="student_passing_year" id="student_passing_year" /></td><td>(Date on Marksheet)</td></tr>
...
<TR><TH COLSPAN="4"> <INPUT TYPE="submit" onclick="return validate12()" value="Submit"></INPUT></TH> </TR>
...
<script src="assets/js/scholarshipform.js"></script>
<title>Student 12th details</title>

</head>
<body>
<center>
<h1>Enter 12th Details</h1>
...
<div class="container">
	...
	<form id="12thAcademicRegistration" modelAttribute="student12thDetails" action="Register12th.do" method="post">
		...
		<table align="center">
			...
			<tr><td colspan="2"><input type="submit" id="register" onclick="return validate12()"></td></tr>
